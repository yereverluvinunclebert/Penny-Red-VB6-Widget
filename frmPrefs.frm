...
Begin VB.Form pennyRedPrefs 
   ...
   Begin VB.Frame fraConfig 
      ...
      Begin VB.Frame fraConfigInner 
         ...
         Begin VB.ComboBox cmbScrollWheelDirection 
            Height          =   315
            ItemData        =   "frmPrefs.frx":3AFA
            Left            =   1995
            List            =   "frmPrefs.frx":3AFC
   ...
   Begin VB.Frame fraPosition 
      ...
      Begin VB.Frame fraPositionInner 
         ...
         Begin VB.ComboBox cmbWidgetLandscape 
            Height          =   315
            ItemData        =   "frmPrefs.frx":3AFE
            Left            =   2250
            List            =   "frmPrefs.frx":3B00
            Style           =   2  'Dropdown List
            TabIndex        =   75
         ...
         Begin VB.ComboBox cmbWidgetPortrait 
            Height          =   315
            ItemData        =   "frmPrefs.frx":3B02
            Left            =   2250
            List            =   "frmPrefs.frx":3B04
            Style           =   2  'Dropdown List
            TabIndex        =   72
            ToolTipText     =   "Choose the alarm sound."
            Top             =   5505
         ...
         Begin VB.ComboBox cmbWidgetPosition 
            Height          =   315
            ItemData        =   "frmPrefs.frx":3B06
            Left            =   2265
            List            =   "frmPrefs.frx":3B08
            Style           =   2  'Dropdown List
            TabIndex        =   69
            ToolTipText     =   "Choose the alarm sound."
            Top             =   2100
         ...
         Begin VB.ComboBox cmbAspectHidden 
            Height          =   315
            ItemData        =   "frmPrefs.frx":3B0A
            Left            =   2265
            List            =   "frmPrefs.frx":3B0C
            Style           =   2  'Dropdown List
            TabIndex        =   66
            ToolTipText     =   "Choose the alarm sound."
            Top             =   0
         ...
         End
         Begin VB.Label lblPosition 
            Caption         =   $"frmPrefs.frx":3D7F
            Height          =   3045
            Index           =   6
            Left            =   2265
            TabIndex        =   68
            Tag             =   "lblAlarmSoundDesc"
            ToolTipText     =   $"frmPrefs.frx":3F1B
            Top             =   450
            Width           =   5175
         End
         Begin VB.Label lblPosition 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.Frame fraDefaultEditor 
            ...
            Begin VB.TextBox txtDefaultEditor 
               ...
               ToolTipText     =   $"frmPrefs.frx":5077
               Top             =   195
               Width           =   3660
            End
            Begin VB.Label lblDebug 
               Caption         =   $"frmPrefs.frx":5109
               Height          =   930
               Index           =   9
               Left            =   1545
               TabIndex        =   144
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":5248
            Left            =   1530
            List            =   "frmPrefs.frx":524A
            Style           =   2  'Dropdown List
            TabIndex        =   56
   ...
   Begin VB.Frame fraGeneral 
      ...
      Begin VB.Frame fraGeneralInner 
         ...
         Top             =   300
         Width           =   6600
         Begin VB.ComboBox cmbStampSelection 
            Height          =   315
            ItemData        =   "frmPrefs.frx":524C
            Left            =   1995
            List            =   "frmPrefs.frx":524E
            Style           =   2  'Dropdown List
            TabIndex        =   146
            Top             =   1290
            Width           =   3720
         ...
         End
         Begin VB.Label lblGeneral 
            Caption         =   "Select which stamp type you would like to see on your desktop *"
            Height          =   480
            Index           =   5
            Left            =   1995
            TabIndex        =   95
   ...
   End
End
Attribute VB_Name = "pennyRedPrefs"
...
chkShowTaskbar_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure chkShowTaskbar_Click of Form pennyRedPrefs"
End Sub

'---------------------------------------------------------------------------------------
' Procedure : cmbStampSelection_Change
' Author    : beededea
' Date      : 01/11/2023
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub cmbStampSelection_Click()
    Dim resourcePath As String: resourcePath = vbNullString
    Dim fullPath As String: fullPath = vbNullString
    
    On Error GoTo cmbStampSelection_Change_Error

    resourcePath = App.Path & "\resources\images"
    
    If cmbStampSelection.ListIndex = 0 Then
        ' fullPath = resourcePath & "\penny red" & " white.jpg"
        PrStampSelection = "0"
    End If
    If cmbStampSelection.ListIndex = 1 Then
        ' fullPath = resourcePath & "\Penny Black" & " white.jpg"
        PrStampSelection = "1"
    End If
    If cmbStampSelection.ListIndex = 2 Then
        ' fullPath = resourcePath & "\Two Penny Blue" & " white.jpg"
        PrStampSelection = "2"
    End If
    If cmbStampSelection.ListIndex = 3 Then
        ' fullPath = resourcePath & "\Hong Kong 10 Dollars" & " white.jpg"
        PrStampSelection = "3"
    End If
    If cmbStampSelection.ListIndex = 4 Then
        ' fullPath = resourcePath & "\Hong Kong 30 Cents" & " white.jpg"
        PrStampSelection = "4"
    End If
    If cmbStampSelection.ListIndex = 5 Then
        ' fullPath = resourcePath & "\Empire Exhibition" & " white.jpg"
        PrStampSelection = "5"
    End If
    
'    If fFExists(fullPath) Then picStampImage.Picture = LoadPicture(fullPath)

    On Error GoTo 0
    Exit Sub

cmbStampSelection_Change_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmbStampSelection_Change of Form pennyRedPrefs"
End Sub
...
Form_Load_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Form_Load of Form pennyRedPrefs"
...
btnAboutDebugInfo_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnAboutDebugInfo_Click of form pennyRedPrefs"
End Sub
...
btnDonate_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnDonate_Click of Form pennyRedPrefs"
End Sub
...
btnFacebook_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnFacebook_Click of Form pennyRedPrefs"
End Sub
...
btnOpenFile_Click_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnOpenFile_Click of Form pennyRedPrefs"
            Resume Next
          End If
    End With
End Sub
...
btnUpdate_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnUpdate_Click of Form pennyRedPrefs"
End Sub
...
btnDefaultEditor_Click_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnDefaultEditor_Click of Form pennyRedPrefs"
            Resume Next
          End If
    End With
...
chkEnableBalloonTooltips_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure chkEnableBalloonTooltips_Click of Form pennyRedPrefs"
End Sub
...
chkIgnoreMouse_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure chkIgnoreMouse_Click of Form pennyRedPrefs"
End Sub
...
Private Sub chkPreventDragging_Click()
    ...
    If chkPreventDragging.Value = 0 Then
        ...
        End If
    Else
        stampWidget.Locked = 1
        PrPreventDragging = "1"
        menuForm.mnuLockWidget.Checked = True
        If aspectRatio = "landscape" Then
            txtLandscapeHoffset.Text = fMain.stampForm.Left
            txtLandscapeVoffset.Text = fMain.stampForm.Top
        Else
            txtPortraitHoffset.Text = fMain.stampForm.Left
            txtPortraitYoffset.Text = fMain.stampForm.Top
        End If
    End If
...
chkPreventDragging_Click_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure chkPreventDragging_Click of Form pennyRedPrefs"
            Resume Next
          End If
    End With
...
chkWidgetHidden_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure chkWidgetHidden_Click of Form pennyRedPrefs"
...
cmbAspectHidden_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmbAspectHidden_Click of Form pennyRedPrefs"
End Sub
...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\Penny Red Widget VB6\Penny Red Widget.vbp"
...
cmbDebug_Click_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmbDebug_Click of Form pennyRedPrefs"
            Resume Next
          End If
    End With
...
Private Sub cmbScrollWheelDirection_Click()
   On Error GoTo cmbScrollWheelDirection_Click_Error
    ...
    btnSave.Enabled = True ' enable the save button
    stampWidget.ZoomDirection = cmbScrollWheelDirection.List(cmbScrollWheelDirection.ListIndex)
...
cmbScrollWheelDirection_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmbScrollWheelDirection_Click of Form pennyRedPrefs"
End Sub
...
cmbWidgetPosition_Click_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmbWidgetPosition_Click of Form pennyRedPrefs"
            Resume Next
          End If
    End With
End Sub
...
IsVisible_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure IsVisible of Form pennyRedPrefs"
            Resume Next
          End If
    End With
End Property
...
showLastTab_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure showLastTab of Form pennyRedPrefs"
...
Private Sub positionPrefsFramesButtons()
    ...
    pennyRedPrefs.Width = rightHandAlignment + leftHandGutterWidth + 75 ' (not quite sure why we need the 75 twips padding)
...
'        pennyRedPrefs.Height = btnHelp.Top + btnHelp.Height + 600
'        lastFormHeight = pennyRedPrefs.Height
'    End If
...
positionPrefsFramesButtons_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure positionPrefsFramesButtons of Form pennyRedPrefs"
...
Private Sub btnCancel_Click()
   On Error GoTo btnCancel_Click_Error
    ...
    btnSave.Enabled = False ' disable the save button
    pennyRedPrefs.themeTimer.Enabled = False
...
btnCancel_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnCancel_Click of Form pennyRedPrefs"
End Sub
'
'---------------------------------------------------------------------------------------
...
Private Sub btnHelp_Click()
    ...
    On Error GoTo btnHelp_Click_Error
        ...
        Else
            MsgBox ("%Err-I-ErrorNumber 11 - The help file - PennyRed Help.html - is missing from the help folder.")
        End If
...
btnHelp_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnHelp_Click of Form pennyRedPrefs"
End Sub
'
'---------------------------------------------------------------------------------------
...
'    Dim thisText As String: thisText = vbNullString
    ...
    PrStampSelection = LTrim$(Str$(cmbStampSelection.ListIndex))
...
'    PrhLocationPercPrefValue
    ...
    If PrStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PennyRedWidget", """" & App.Path & "\" & "Penny Red.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PennyRedWidget", vbNullString)
    End If

    ' save the values from the general tab
    If fFExists(PrSettingsFile) Then
        sPutINISetting "Software\PennyRed", "enableTooltips", PrEnableTooltips, PrSettingsFile
        sPutINISetting "Software\PennyRed", "enableBalloonTooltips", PrEnableBalloonTooltips, PrSettingsFile
        sPutINISetting "Software\PennyRed", "showTaskbar", PrShowTaskbar, PrSettingsFile
        
        sPutINISetting "Software\PennyRed", "gaugeSize", PrGaugeSize, PrSettingsFile
        sPutINISetting "Software\PennyRed", "scrollWheelDirection", PrScrollWheelDirection, PrSettingsFile
                
        sPutINISetting "Software\PennyRed", "gaugeFunctions", PrGaugeFunctions, PrSettingsFile
        sPutINISetting "Software\PennyRed", "stampSelection", PrStampSelection, PrSettingsFile
        'sPutINISetting "Software\PennyRed", "widgetSkew", 'PrWidgetSkew, PrSettingsFile
        
        sPutINISetting "Software\PennyRed", "aspectHidden", PrAspectHidden, PrSettingsFile
        sPutINISetting "Software\PennyRed", "widgetPosition", PrWidgetPosition, PrSettingsFile
        sPutINISetting "Software\PennyRed", "widgetLandscape", PrWidgetLandscape, PrSettingsFile
        sPutINISetting "Software\PennyRed", "widgetPortrait", PrWidgetPortrait, PrSettingsFile

        sPutINISetting "Software\PennyRed", "prefsFont", PrPrefsFont, PrSettingsFile
        sPutINISetting "Software\PennyRed", "prefsFontSize", PrPrefsFontSize, PrSettingsFile
        sPutINISetting "Software\PennyRed", "prefsFontItalics", PrPrefsFontItalics, PrSettingsFile
        sPutINISetting "Software\PennyRed", "prefsFontColour", PrPrefsFontColour, PrSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\PennyRed", "windowLevel", PrWindowLevel, PrSettingsFile
        sPutINISetting "Software\PennyRed", "preventDragging", PrPreventDragging, PrSettingsFile
        
        sPutINISetting "Software\PennyRed", "opacity", PrOpacity, PrSettingsFile
        sPutINISetting "Software\PennyRed", "widgetHidden", PrWidgetHidden, PrSettingsFile
        sPutINISetting "Software\PennyRed", "hidingTime", PrHidingTime, PrSettingsFile
        sPutINISetting "Software\PennyRed", "ignoreMouse", PrIgnoreMouse, PrSettingsFile
        
        sPutINISetting "Software\PennyRed", "startup", PrStartup, PrSettingsFile

        sPutINISetting "Software\PennyRed", "enableSounds", PrEnableSounds, PrSettingsFile
        sPutINISetting "Software\PennyRed", "lastSelectedTab", PrLastSelectedTab, PrSettingsFile
        
        sPutINISetting "Software\PennyRed", "debug", PrDebug, PrSettingsFile
        sPutINISetting "Software\PennyRed", "dblClickCommand", PrDblClickCommand, PrSettingsFile
        sPutINISetting "Software\PennyRed", "openFile", PrOpenFile, PrSettingsFile
        sPutINISetting "Software\PennyRed", "defaultEditor", PrDefaultEditor, PrSettingsFile
...
'        msgCnt = 0
    ...
    ' sets the characteristics of the stamp and menus immediately after saving
    Call adjustMainControls
    
    pennyRedPrefs.SetFocus
...
btnSave_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnSave_Click of Form pennyRedPrefs"
...
Private Sub btnPrefsFont_Click()
    ...
    Call changeFont(pennyRedPrefs, True, fntFont, fntSize, fntWeight, fntStyle, fntColour, fntItalics, fntUnderline, fntFontResult)
    ...
    If fFExists(PrSettingsFile) Then ' does the tool's own settings.ini exist?
        sPutINISetting "Software\PennyRed", "prefsFont", PrPrefsFont, PrSettingsFile
        sPutINISetting "Software\PennyRed", "prefsFontSize", PrPrefsFontSize, PrSettingsFile
        sPutINISetting "Software\PennyRed", "prefsFontItalics", PrPrefsFontItalics, PrSettingsFile
        sPutINISetting "Software\PennyRed", "PrefsFontColour", PrPrefsFontColour, PrSettingsFile
...
btnPrefsFont_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnPrefsFont_Click of Form pennyRedPrefs"
...
Private Sub adjustPrefsControls()
    ...
    cmbStampSelection.ListIndex = Val(PrStampSelection)
    ...
    If PrPrefsFont <> vbNullString Then
        Call changeFormFont(pennyRedPrefs, PrPrefsFont, Val(PrPrefsFontSize), fntWeight, fntStyle, PrPrefsFontItalics, PrPrefsFontColour)
    End If
...
adjustPrefsControls_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure adjustPrefsControls of Form pennyRedPrefs on line " & Erl
...
Private Sub populatePrefsComboBoxes()
    ...
    ' populate the stamp selection combobox
    cmbStampSelection.AddItem "Penny Red", 0
    cmbStampSelection.ItemData(0) = 1
    cmbStampSelection.AddItem "Penny Black", 1
    cmbStampSelection.ItemData(1) = 5
    cmbStampSelection.AddItem "Two Penny Blue", 2
    cmbStampSelection.ItemData(2) = 10
    cmbStampSelection.AddItem "Hong Kong 10 Dollars", 3
    cmbStampSelection.ItemData(3) = 10
    cmbStampSelection.AddItem "Hong Kong 30 Cents", 4
    cmbStampSelection.ItemData(4) = 20
    cmbStampSelection.AddItem "Empire Exhibition", 5
    cmbStampSelection.ItemData(5) = 30
...
populatePrefsComboBoxes_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure populatePrefsComboBoxes of Form pennyRedPrefs"
            Resume Next
          End If
    End With
...
clearBorderStyle_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure clearBorderStyle of Form pennyRedPrefs"
...
Form_Resize_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Form_Resize of Form pennyRedPrefs"
            Resume Next
          End If
    End With
End Sub
...
Form_Unload_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Form_Unload of Form pennyRedPrefs"
End Sub
...
'Private Sub cmbStampSelection_Change()
'    stampWidget.RotationSpeed = cmbStampSelection.Value
'    btnSave.Enabled = True ' enable the save button
'
'End Sub
...
'    btnSave.Enabled = True ' enable the save button
'    stampWidget.stampSkewDeg = 'sliWidgetSkew.Value
'End Sub
...
Private Sub sliGaugeSize_Change()
    ...
    btnSave.Enabled = True ' enable the save button
    If gblAllowSizeChangeFlg = True Then stampWidget.Zoom = sliGaugeSize.Value / 100
...
sliGaugeSize_Change_Error:
     ...
     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure sliGaugeSize_Change of Form pennyRedPrefs"
End Sub

Private Sub sliOpacity_Change()
    btnSave.Enabled = True ' enable the save button
    stampWidget.opacity = sliOpacity.Value / 100
    PrOpacity = LTrim$(Str$(sliOpacity.Value))
End Sub
...
Public Sub setPrefsTooltips()
   ...
   On Error GoTo setPrefsTooltips_Error
    ...
    If PrEnableTooltips = "1" Then
        ...
        cmbStampSelection.ToolTipText = "Select the stamp image you wish to appear on your desktop."
        ...
        cmbScrollWheelDirection.ToolTipText = "To change the direction of the mouse scroll wheel when resiziing the stamp gauge."
        ...
        sliGaugeSize.ToolTipText = "Adjust to a percentage of the original size. Any adjustment in size takes place instantly (you can also use Ctrl+Mousewheel hovering over the stamp itself)."
        'sliWidgetSkew.ToolTipText = "Adjust to a degree skew of the original position. Any adjustment in direction takes place instantly (you can also use the Mousewheel hovering over the stamp itself."
    ...
    Else
        ...
        cmbStampSelection.ToolTipText = vbNullString
...
setPrefsTooltips_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure setPrefsTooltips of Form pennyRedPrefs"
...
DestroyToolTip_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure DestroyToolTip of Form pennyRedPrefs"
End Sub
'---------------------------------------------------------------------------------------
...
loadPrefsAboutText_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure loadPrefsAboutText of Form pennyRedPrefs"
...
Private Sub picButtonMouseUpEvent(ByVal thisTabName As String, ByRef thisPicName As Image, ByRef thisPicNameClicked As Image, ByRef thisFraName As Frame, Optional ByRef thisFraButtonName As Frame)
    ...
    If dynamicSizingFlg = False Then
        ...
        pennyRedPrefs.Height = lastFormHeight
    End If
...
picButtonMouseUpEvent_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure picButtonMouseUpEvent of Form pennyRedPrefs"
...
'
'    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure scrollFrameDownward of Form pennyRedPrefs"
'
'End Sub
...
themeTimer_Timer_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure themeTimer_Timer of Form pennyRedPrefs"
...
mnuCoffee_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuCoffee_Click of Form pennyRedPrefs"
End Sub
...
mnuLicenceA_Click_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuLicenceA_Click of Form pennyRedPrefs"
            Resume Next
          End If
    End With
...
mnuSupport_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuSupport_Click of Form pennyRedPrefs"
End Sub
...
Private Sub mnuAuto_Click()
   ...
   On Error GoTo mnuAuto_Click_Error
    ...
    If pennyRedPrefs.themeTimer.Enabled = True Then
            MsgBox "Automatic Theme Selection is now Disabled"
            pennyRedPrefs.mnuAuto.Caption = "Auto Theme Disabled - Click to Enable"
            pennyRedPrefs.mnuAuto.Checked = False
    ...
    Else
            ...
            pennyRedPrefs.mnuAuto.Caption = "Auto Theme Enabled - Click to Disable"
            pennyRedPrefs.mnuAuto.Checked = True
            
            pennyRedPrefs.themeTimer.Enabled = True
            Call setThemeColour
    End If
...
mnuAuto_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuAuto_Click of Form pennyRedPrefs"
End Sub
...
Private Sub mnuDark_Click()
   On Error GoTo mnuDark_Click_Error
    ...
    pennyRedPrefs.mnuAuto.Caption = "Auto Theme Disabled - Click to Enable"
    pennyRedPrefs.mnuAuto.Checked = False
    pennyRedPrefs.mnuDark.Caption = "Dark Theme Enabled"
    pennyRedPrefs.mnuLight.Caption = "Light Theme Enable"
    pennyRedPrefs.themeTimer.Enabled = False
...
mnuDark_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuDark_Click of Form pennyRedPrefs"
End Sub
...
Private Sub mnuLight_Click()
   ...
   On Error GoTo mnuLight_Click_Error
    ...
    pennyRedPrefs.mnuAuto.Caption = "Auto Theme Disabled - Click to Enable"
    pennyRedPrefs.mnuAuto.Checked = False
    pennyRedPrefs.mnuDark.Caption = "Dark Theme Enable"
    pennyRedPrefs.mnuLight.Caption = "Light Theme Enabled"
    pennyRedPrefs.themeTimer.Enabled = False
...
mnuLight_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuLight_Click of Form pennyRedPrefs"
End Sub
...
Private Sub setThemeShade(ByVal redC As Integer, ByVal greenC As Integer, ByVal blueC As Integer)
    ...
    pennyRedPrefs.BackColor = RGB(redC, greenC, blueC)
    
    ' all buttons must be set to graphical
    For Each ctrl In pennyRedPrefs.Controls
    ...
    'pennyRedPrefs.sliStampSelection.BackColor = RGB(redC, greenC, blueC)
    'pennyRedPrefs.'sliWidgetSkew.BackColor = RGB(redC, greenC, blueC)
    pennyRedPrefs.sliGaugeSize.BackColor = RGB(redC, greenC, blueC)
    pennyRedPrefs.sliOpacity.BackColor = RGB(redC, greenC, blueC)
    pennyRedPrefs.txtAboutText.BackColor = RGB(redC, greenC, blueC)
    
    sPutINISetting "Software\PennyRed", "skinTheme", PrSkinTheme, PrSettingsFile ' now saved to the toolsettingsfile
...
adjustPrefsTheme_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure adjustPrefsTheme of Form pennyRedPrefs"
...
positionTimer_Timer_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure positionTimer_Timer of Form pennyRedPrefs"
End Sub
...
chkEnableResizing_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure chkEnableResizing_Click of Form pennyRedPrefs"
...
setframeHeights_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure setframeHeights of Form pennyRedPrefs"
End Sub
