...
Begin VB.Form menuForm 
   ...
   Begin VB.Menu mnuMainMenu 
      ...
      Begin VB.Menu mnuAbout 
         Caption         =   "About Penny Red Cairo widget"
      End
      ...
      Begin VB.Menu mnuHelpSplash 
         Caption         =   "Penny Red One-Page Help"
      End
...
Private Sub mnuAppFolder_Click()
   ...
   On Error GoTo mnuAppFolder_Click_Error
    ...
    Else
        MsgBox "Having a bit of a problem opening a folder for this widget - " & folderPath & " It doesn't seem to have a valid working directory set.", "Penny Red Widget Confirmation Message", vbOKOnly + vbExclamation
        'MessageBox Me.hWnd, "Having a bit of a problem opening a folder for that command - " & sCommand & " It doesn't seem to have a valid working directory set.", "Penny Red Gauge Confirmation Message", vbOKOnly + vbExclamation
    End If
...
Private Sub mnuEditWidget_Click()
   ...
   On Error GoTo mnuEditWidget_Click_Error
    ...
    Else
        MsgBox "Having a bit of a problem opening an IDE for this widgt - " & editorPath & " It doesn't seem to have a valid working directory set.", "Penny Red Widget Confirmation Message", vbOKOnly + vbExclamation
        'MessageBox Me.hWnd, "Having a bit of a problem opening a folder for that command - " & sCommand & " It doesn't seem to have a valid working directory set.", "Penny Red Widget Confirmation Message", vbOKOnly + vbExclamation
    End If
...
Private Sub mnuHelpHTM_Click()
    On Error GoTo mnuHelpHTM_Click_Error
        ...
        Else
            MsgBox ("The help file - PennyRed.html.html- is missing from the help folder.")
        End If
...
Public Sub mnuLatest_Click()
    ...
    If answer = vbYes Then
        Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Penny-Red-VB6-Widget/raw/main/Setup.exe", vbNullString, App.Path, 1)
    End If
